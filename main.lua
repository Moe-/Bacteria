...
function love.load ()
    ...
    snd_shoot = love.audio.newSource("data/schuss.mp3", "static")
	 snd_shoot2 = love.audio.newSource("data/schuss2.wav", "static")
	 snd_shoot3 = love.audio.newSource("data/schuss3.wav", "static")
	 snd_shoot4 = love.audio.newSource("data/schuss4.wav", "static")
	 snd_shoot5 = love.audio.newSource("data/schuss5.wav", "static")
	 snd_shoot6 = love.audio.newSource("data/schuss5.wav", "static")

	snd_shoot4:setVolume(0.5)

	 snd_powerup = love.audio.newSource("data/powerup.wav", "static")
	 snd_powerup2 = love.audio.newSource("data/powerup2.wav", "static")
	 snd_powerup3 = love.audio.newSource("data/powerup3.wav", "static")
    snd_powerup4 = love.audio.newSource("data/powerup4.wav", "static")

	snd_collision = love.audio.newSource("data/collision.wav", "static")

    snd_explosion = love.audio.newSource("data/explosion.mp3", "static")
	snd_explosion2 = love.audio.newSource("data/explosion2.wav", "static")
	snd_explosion3 = love.audio.newSource("data/explosion3.wav", "static")
	snd_explosion4 = love.audio.newSource("data/explosion4.wav", "static")
	snd_explosion5 = love.audio.newSource("data/explosion5.wav", "static")
	snd_explosion6 = love.audio.newSource("data/explosion6.wav", "static")
	snd_explosion7 = love.audio.newSource("data/explosion7.wav", "static")
   ...
   snd_bossfight:setVolume(0.75)
	...
	snd_hit = love.audio.newSource("data/hit.wav", "static")
	snd_hit2 = love.audio.newSource("data/hit2.wav", "static")
